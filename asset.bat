...
set "fileTypes=%fileTypes% *.pdf *.doc *.docx *.xls *.xlsx *.ppt *.pptx *.txt *.rtf *.odt *.ods *.odp *.wpd *.html *.htm *.csv *.md"
set "fileTypes=%fileTypes% *.py *.java *.js *.c *.cpp *.cs *.rb *.php *.swift *.go *.kt *.r *.css *.ts *.sh *.pl *.m *.hs *.lua *.asm *.scala *.ex *.exs *.dart *.bat"
set "fileTypes=%fileTypes% *.bmp *.gif *.tiff *.epub"
